...
CYCLE_ID = '83b91bca-44fc-46b2-abf2-31390e94189e' # September 2026 cycle

AGENTS = [
    {'id': '9500c8c8-581e-444d-9543-65b1d49d877a', 'name': 'admin'}
]
...
def main():
    excel_file = sys.argv[1] if (len(sys.argv) > 1 and sys.argv[1].strip()) else 'meter_images/Upload 21.09.2026.xlsx'
